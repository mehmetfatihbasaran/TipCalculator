...
fun getMovies(): List<Movie> {
    return listOf(
        ...
        Movie(
            ...
            actors = "Shameik Moore, Jake Johnson, Hailee Steinfeld, Brian Tyree",
            plot = "A young Peter Parker, a high school student who was orphaned when his parents were killed, gains superpowers after being bitten by a genetically-altered spider.",
            poster = "http://ia.media-imdb.com/images/M/MV5BMjMwNDUwMTU5OV5BMl5BanBnXkFtZTgwNTkwNTQ3NjM@._V1_SX300.jpg",
            images = listOf(
                "https://www.imdb.com/title/tt4633694/mediaviewer/rm350909952?ref_=tt_ov_mi_sm",
                "https://www.imdb.com/title/tt4633694/mediaviewer/rm334132736/",
                "https://www.imdb.com/title/tt4633694/mediaviewer/rm317355520/",
            ),
            rating = "8.4"
        )
